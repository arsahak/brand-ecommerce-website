...
export default function Collection() {
  return (
    <div className="w-full container mx-auto py-12 px-4">
      <h2 className="text-center text-2xl font-medium tracking-wide mb-12">OUR COLLECTION</h2>

      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <Link href="/clothes" className="block">
          <div className="relative overflow-hidden">
            <div className="relative aspect-[4/3]">
              <Image src="/assets/product/threePiece-1.jpg" alt="Clothes collection" fill className="object-cover" />
              <div className="absolute inset-0 bg-black bg-opacity-[45%] flex items-center justify-center">
                <span className="text-white text-3xl font-normal">Clothes</span>
              </div>
            </div>
          </div>
        </Link>
        ...
        <Link href="/cosmetics" className="block">
          <div className="relative overflow-hidden">
            <div className="relative aspect-[4/3]">
              <Image src="/assets/product/collection-2.png" alt="Cosmetics collection" fill className="object-cover" />
              <div className="absolute inset-0 bg-black bg-opacity-[45%] flex items-center justify-center">
                <span className="text-white text-3xl font-normal">Cosmetics</span>
              </div>
            </div>
          </div>
        </Link>
