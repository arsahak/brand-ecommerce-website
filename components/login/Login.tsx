        ...
        <div className="w-full md:max-w-[70%] mx-auto mt-12 flex justify-center">
          <ImageMotion>
            <form className="!w-full font-aviano-regular uppercase">
              ...
              <div className="mb-6">
                <button className="text-base md:text-lg rounded w-full py-3  outline-none bg-black text-white hover:bg-gray-800 transition duration-300">
                  Log In
                </button>
              </div>
              ...
              <div className="space-y-4">
                ...
                <button
                  type="button"
                  className="flex items-center justify-center text-base md:text-lg rounded w-full py-3 outline-none bg-[#1877F2] text-white hover:bg-[#1865D1] transition duration-300"
                >
