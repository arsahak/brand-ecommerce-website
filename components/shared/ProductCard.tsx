...
const ProductCard: FC<{ product: Product }> = ({ product }) => {
    ...
    return (
        <div className="bg-white rounded-lg  border hover:shadow-lg transition-shadow">
            <div className="relative group overflow-hidden border-b h-72 w-full"
            ...
            >
                ...
                <div
                    ...
                    <button
                        ...
                        className="text-primary border border-primary rounded-lg hover:!bg-primary/80 hover:!text-white hover:scale-125 p-1 flex justify-center"
                    > <FaRegHeart /></button>
                    {/* </Tooltip> */}
